...
insert into product_categories (
    ...
    product_category_image_unselect
) values
...
insert into products (
    ...
    reserved_stock
      ...
      (
          ...
          true,
          true,
          'https://placehold.co/600x400/png?text=Rice',
          100,
          0
      ),
      (
          ...
          true,
          true,
          'https://placehold.co/600x400/png?text=Oil',
          100,
          0
      ),
      (
          ...
          true,
          true,
          'https://placehold.co/600x400/png?text=Tomato',
          100,
          0
      ),
      (
          ...
          false,
          true,
          'https://placehold.co/600x400/png?text=Water',
          300,
          0
      ),
      (
          ...
          true,
          true,
          'https://placehold.co/600x400/png?text=Soda',
          200,
          0
      ),
      (
          '00000000-0000-0000-0000-000000000301',
          'مایع ظرفشویی ۳ لیتری',
          300101,
          'کارتن',
          'کارتن',
          'BOX',
          ...
          true,
          true,
          'https://placehold.co/600x400/png?text=Detergent',
          80,
          0
      ),
      (
          ...
          true,
          true,
          'https://placehold.co/600x400/png?text=Chips',
          150,
          0
      );
...
insert into customer_addresses (
    ...
    is_default
      ...
      (
          ...
          '11111111-1111-1111-1111-111111111111',
          'انبار مرکزی',
          'تهران، خیابان آزادی، پلاک ۱۰۰، فروشگاه نمونه',
          '09120000001',
          '02144000001',
          35.6892,
          51.3890,
      ...
      (
          ...
          '11111111-1111-1111-1111-111111111111',
          'شعبه دوم',
          'تهران، صادقیه، بلوار فردوس، پلاک ۲۰',
          '09120000001',
          '02144000002',
          null,
          null,
...
insert into payment_terms (
    ...
    dead_line,
    payment_kind,
    immediate_discount_percent,
    receipt_discount_percent,
    cheque_discount_percent,
    active
) values
      (
      ...
      (
          '16ccab60-279b-410a-90d1-b2673d5d1dd1',
          'رسید ۳۰ روزه',
          30,
          'RECEIPT',
          0,
